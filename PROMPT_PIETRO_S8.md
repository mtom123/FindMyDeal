# Prompt Pietro — Sessione S8: Espansione Drink TOP 6 città Italia (03/06/2026)

> ⚠️ **PARTE QUANDO S7 È CHIUSA.**
> S7 (discovery comune/CKAN/OSM Milano, già in corso) → completala prima.
> S8 = espansione drink Milano → 6 nuove città Italia.
>
> **CAMBIO DI ROTTA CEO/Utente** (call 03/06 sera): SurPrice si espande dal solo Milano a **6 nuove città Italia** (oltre Milano stesso). Tu sei l'unico scraper drink. Replica il playbook Milano per le 6 città target.
>
> **Target**: 6 nuove città, ognuna con stesso pattern dati che hai costruito per Milano (DB + no-price layer + price points).
